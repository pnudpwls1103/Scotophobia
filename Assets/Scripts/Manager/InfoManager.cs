...
public class InfoManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(30000, new string[]{"아빠 방"});
        talkData.Add(40000, new string[]{"내 방"});

        talkData.Add(60000, new string[]{"복도"});

        talkData.Add(10000 + 1000, new string[]{"조리공간이다."});
        talkData.Add(10000 + 1000 + 30, new string[]{"조리공간 위에 재료들이 있다."});
        
        talkData.Add(20000 + 1000, new string[]{"아빠의 책이 가득 찬 책장이다."});
        talkData.Add(20000 + 1000 + 70, new string[]{"이상한 문양이 그려진 책들이 있다."});
