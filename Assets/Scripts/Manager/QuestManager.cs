...
public class QuestManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        questList.Add(0, new QuestData("½ÃÀÛ ÄÆ¾À", new int[]{}));
        questList.Add(10, new QuestData("½ÃÀÛ", new int[]{}));
        questList.Add(20, new QuestData("½ÃÀÛÆäÀÌÁö Å¬¸¯", new int[]{}));
        questList.Add(30, new QuestData("»÷µåÀ§Ä¡ ¸¸µé±â", new int[]{1000}));
        questList.Add(40, new QuestData("»÷µåÀ§Ä¡ °Ç³»ÁÖ±â", new int[]{2000}));
        questList.Add(50, new QuestData("»÷µåÀ§Ä¡ °Ç³»ÁÖ±â ÄÆ¾À", new int[]{2000}));
        questList.Add(60, new QuestData("½ºÅ×ÀÌÁö1 ÀÚ¹°¼è ¿­±â", new int[]{3000}));
        questList.Add(70, new QuestData("Ã¥ ¹è¿­", new int[]{4000}));
        questList.Add(80, new QuestData("°ø »Ì±â", new int[]{5000}));
    }
